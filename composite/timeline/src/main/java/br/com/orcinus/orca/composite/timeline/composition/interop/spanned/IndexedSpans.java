...
import br.com.orcinus.orca.composite.timeline.composition.interop.spanned.span.AnyExtensions;
  ...
  public List<Style> toStyles() {
    ...
    for (Object span : spans) {
      ...
      List<Style> spanStyles =
          br.com.orcinus.orca.composite.timeline.composition.interop.spanned.span.AnyExtensions
              .toStyles(span, inclusiveIndices);

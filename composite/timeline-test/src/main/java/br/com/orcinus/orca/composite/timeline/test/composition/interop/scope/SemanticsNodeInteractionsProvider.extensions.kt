...
/** [SemanticsNodeInteraction] of an [CompositionTextField]. */
@InternalTimelineApi
@VisibleForTesting
fun SemanticsNodeInteractionsProvider.onCompositionTextField(): SemanticsNodeInteraction {
  return onNodeWithTag(CompositionTextFieldTag)
}

...
package com.jeanbarrossilva.orca.composite.timeline.test.post
...
fun SemanticsNodeInteractionsProvider.onPostPreviews(): SemanticsNodeInteractionCollection {
  return onAllNodes(isPostPreview())
}

/** [SemanticsNodeInteraction] of a [PostPreview] node. */
fun SemanticsNodeInteractionsProvider.onPostPreview(): SemanticsNodeInteraction {

...
/**
 * Structure returned by the API that is the DTO version of either an [MastodonToot] or a [Reblog];
...
internal constructor(
  ...
  /**
   * Converts this [MastodonStatus] into a [Toot].
   *
  ...
  internal fun toToot(imageLoaderProvider: ImageLoader.Provider<URL>): Toot {
    ...
    return MastodonToot(
      ...
      .`if`<Toot>(reblog != null) {
        val reblogger = this@MastodonStatus.account.toAuthor(imageLoaderProvider)

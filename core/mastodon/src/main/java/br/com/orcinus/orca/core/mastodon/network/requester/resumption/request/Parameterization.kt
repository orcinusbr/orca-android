...
import br.com.orcinus.orca.core.mastodon.network.requester.resumption.request.headers.strings.toParameters
...
internal sealed class Parameterization<T : Any> {
  ...
  companion object {
    ...
    fun deserialize(name: String, serializedContent: String): Parameterization<*> {
      val serializer = fold(name, onBody = Body::serializer, onHeaders = Headers::serializer)

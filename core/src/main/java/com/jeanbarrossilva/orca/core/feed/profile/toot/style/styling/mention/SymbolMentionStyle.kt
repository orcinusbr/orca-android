...
/**
 * [Style] that considers [Mention]s parts of a [String] starting with a [Mention.SYMBOL] and
 * determines its end by the absence of alphanumeric or some other special characters.
 **/
object SymbolMentionStyle : Style() {

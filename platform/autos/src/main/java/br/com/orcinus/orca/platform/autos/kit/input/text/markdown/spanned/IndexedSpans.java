...
import br.com.orcinus.orca.platform.autos.kit.input.text.markdown.spanned.span.AnyExtensions;
  ...
  List<Style> toStyles() {
    ...
    for (Object span : spans) {
      List<Style> spanStyles =
          br.com.orcinus.orca.platform.autos.kit.input.text.markdown.annotated.span.AnyExtensions
              .toStyles(span, getIndices());

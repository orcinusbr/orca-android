...
import com.jeanbarrossilva.orca.platform.ui.component.timeline.toot.TOOT_PREVIEW_REBLOG_METADATA_TAG
...
/** [SemanticsNodeInteraction] of [SampleTootPreview]'s body node. */
...
/** [SemanticsNodeInteraction] of [SampleTootPreview]'s comment count stat node. */
...
/** [SemanticsNodeInteraction] of [SampleTootPreview]'s favorite count stat node. */
...
/** [SemanticsNodeInteraction] of [SampleTootPreview]'s metadata node. */
...
/** [SemanticsNodeInteraction] of [SampleTootPreview]'s name node. */
...
/** [SemanticsNodeInteraction] of [SampleTootPreview]'s reblog count stat node. */
...
/** [SemanticsNodeInteraction] of [SampleTootPreview]'s reblog metadata node. */
internal fun ComposeTestRule.onTootPreviewReblogMetadata(): SemanticsNodeInteraction {
  return onNodeWithTag(TOOT_PREVIEW_REBLOG_METADATA_TAG, useUnmergedTree = true)
}

/** [SemanticsNodeInteraction] of [SampleTootPreview]'s share action node. */
